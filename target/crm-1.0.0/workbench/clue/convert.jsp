...
<meta charset="UTF-8">
	...
	$(function(){
		...
		$("#isCreateTransaction").click(function () {
			...
			//将Redis中的数据字典展示出来
			$.ajax({
                url:"workbench/clue/dicStageList.do",
                data:{
                    "stage":"stage"
                },
                type:"get",
                ...
                success:function (data) {
                    ...
                    $.each(data.stage,function (i,n) {
						stageHtml += "<option value='"+n.value+"'>"+n.text+"</option>";
                    });
		...
		$("#convertBtn").click(function () {
			//根据为客户创建交易的复选框有没有选上,判断是否需要创建交易
			if($("#isCreateTransaction").prop("checked")){
				//需要创建交易,传一个clueId之外还有表单中的信息
				//提交表单
				$("#tranForm").submit()
			}else {
				//不需要创建交易,传一个clueId
