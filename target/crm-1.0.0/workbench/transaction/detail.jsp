...
<%@ page import="com.evo.crm.workbench.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="com.evo.crm.workbench.domain.Tran" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%
String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/";

	//准备字典类型为stage的字典值列表
	List<DicValue> dvList = (List<DicValue>) request.getAttribute("dicValueList");
	...
	function changeStage(stage,index) {
		$.ajax({
			...
			success:function (data) {
				if(data.success){
					//改变阶段成功，局部刷新详细页上阶段、可能性、修改人、修改时间
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;" id="stageDiv">
		...
		-------------%>
		<span id="spanEnd" class="closingDate">${tran.expectedDate}</span>
	</div>
