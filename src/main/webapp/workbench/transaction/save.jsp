...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	<script type="text/javascript">
		...
		$(function () {
			...
			//页面加载完毕向后台索取页面显示信息（数据字典）
			$.ajax({
				url:"workbench/transaction/display.do",
				data:{
					"stage":"stage",
					"source":"source",
				...
				success:function (data) {
					...
					$.each(data.transactionType,function (i,n) {
						typeHtml += "<option value='"+n.value+"'>"+n.text+"</option>";
					});
					$("#create-transactionType").html(typeHtml);
			...
			$("#create-transactionStage").change(function () {
				...
				/*
					...
					因为stage是一个可变的变量
					如果是这样的key，不能以传统的json.key的形式来取值
					要使用的取值方式为
					json[key]
				 */
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-customerName" name="customerName" placeholder="支持自动补全，输入客户不存在则新建" name="money">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="抖音推广">
				<input type="hidden" value="36f0e32a89b94ebf8c35fb4e984b3f0e" name="activityId">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="122e8a15539445459092e758e865c065" name="contactsId">
			</div>
		</div>
